...
export const TechSkill = ({ children, framerMotionProps }: TechSkillProps) => {
    return <Span framerMotionProps={framerMotionProps} overrides='text-main-light border-solid border rounded text-xs px-2 py-1 grid items-center'>{children}</Span>;
};
